(() => {
  ...
  function Widget() {
    ...
    return /* @__PURE__ */ figma.widget.h(Frame, {
      ...
      letterSpacing: 1.456,
      fontWeight: 700
    }, "Skill LEVEL (", userLevel, ")"), /* @__PURE__ */ figma.widget.h(SVG, {
  ...
  function Skill(name, category, color, skill_description, skill_key, status, showLevels, voteMap, voteFutureMap) {
    ...
    return /* @__PURE__ */ figma.widget.h(Frame, {
      ...
      letterSpacing: -0.456,
      fontWeight: 700
    }, status == "Current" ? voteMap.get(skill_key) : voteFutureMap.get(skill_key) || "Not Chosen Yet"), /* @__PURE__ */ figma.widget.h(Text, {
